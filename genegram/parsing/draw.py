...
from genegram.parsing.cfpq import CNF, BooleanMatrixGraph, all_pairs_reachability_matrix
from genegram.shared import PARSING, NUCLEOTIDE_TO_COLOR
...
def seq_fasta_to_pictures(seq_fasta: Path, target_dir: Path) -> None:
    ...
    # load grammar
    path_to_grammar = str(PARSING / "grammar.txt")
